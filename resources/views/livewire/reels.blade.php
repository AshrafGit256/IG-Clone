<div class="lg:px-8 flex flex-col h-ful my-auto overflow-hidden">
    <ul class=" h-[calc(100vh_-_1rem)] my-auto flex flex-col gap-y-6 snap-y snap-mandatory overflow-x-hidden">
        ...
        <li class=" h-[calc(100vh_-_5rem)] max-w-sm mx-auto w-full cursor-pointer rounded-lg relative group shrink-0 snap-center snap-always grid grid-cols-12 gap-4">
            ...
            <div class="col-span-1 flex flex-col gap-y-8 items-center justify-end">
                ...
                <div class="flex flex-col gap-y-1 items-center">
                    ...
                    <button onclick="Livewire.dispatch('openModal', { component: 'post.view.modal', arguments: { postId: {{ $post->id }} } })">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.9" stroke="currentColor" class="size-7">
